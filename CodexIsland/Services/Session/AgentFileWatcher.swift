...
private let logger = Logger(subsystem: "com.codexisland", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.codexisland.agentfilewatcher", qos: .userInitiated)
